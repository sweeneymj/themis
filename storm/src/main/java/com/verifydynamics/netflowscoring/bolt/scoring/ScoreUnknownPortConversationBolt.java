...
public class ScoreUnknownPortConversationBolt extends ScoreGenericPortBolt {
    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(ScoreUnknownPortConversationBolt.class);

    public ScoreUnknownPortConversationBolt(String scoreCategory, String scoreCode, Integer score, boolean isGoodScore, String portFileName, int protocol, int minPackets) {
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        LOG.info("ScoreUnknownPortConversationBolt (" + scoreCode + ") - record id = " + flowId);

		if (netFlowBean.getProtocol() == this.protocol) {
            // traffic conversation between ports we dont know about
