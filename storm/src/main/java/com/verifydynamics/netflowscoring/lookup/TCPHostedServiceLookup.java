...
public class TCPHostedServiceLookup extends GenericServiceLookup {
    ...
    private static TCPHostedServiceLookup instance = new TCPHostedServiceLookup();

    // singleton
    private TCPHostedServiceLookup() {
        super(6, true);
    }

    public static TCPHostedServiceLookup getInstance() {
        return instance;
    }
